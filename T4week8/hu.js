...
function updateTotalPrice() {
    ...
    if (!totalPriceElement) {
        ...
        totalPriceDisplay.setAttribute('class', 'total-price');
        totalPriceDisplay.innerHTML = `<h2>Total: $<span>0.00</span></h2>`;
        document.querySelector('.two_col').appendChild(totalPriceDisplay);
    }
